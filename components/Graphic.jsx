        ...
        <div>
            <div class="flex h-auto flex-col md:flex-row w-full bg-[#044C35] p-8">
                <div class="  w-full bg-white">
                    ...
                    <div className='bg-black text-md rounded-xl lg:w-72 p-6 '>
                        <div className=" text-[#C6D1BD]">
                            <h3 class="text-xl font-semibold ">Unleash the power of</h3>
                    ...
                    <div className='bg-[#074F3C] text-[#C6CDC5] text-md flex justify-between rounded-2xl m-10 p-10'>
                        <div className=" ">
                            <h3 class="text-xl font-semibold ">Coding Expertise</h3>
                            <p class="">Mastering the art of web development.</p>
                        </div>
                        <div className="">
                            <h3 class="text-xl font-semibold ">Creative Visually</h3>
                            <p class="">Stunning Designs.</p>
                        </div>
                    </div>
                </div>
                <div class="grid grid-col-2 gap-4 space-y-4 md:grid-cols-3 lg:gap-6 lg:space-y-10 bg-card p-16  h-auto lg:my-10 text-[#E6EBE7] ">
                    <div className='w-full h-20'>
                        <h2 class="text-lg font-bold text-[#AFC4B6]">UI/UX</h2>
                        <h3 class="text-xl font-semibold text-white">Graphic Design</h3>
                        <p class="text-[#AFC4B6] pr-10 mt-4">Seamlessly blending creativity and technical prowess to deliver.</p>
                    </div>
                    <div className='w-full h-20'>
                        <h3 class="text-lg font-semibold text-[#AFC4B6]">Graphic Design</h3>
                        <h3 class="text-xl font-semibold text-white">Branding</h3>
                        <p class="text-[#AFC4B6] pr-10 mt-4">With an unwavering commitment to excellence.</p>
                    </div>
                    <div className='w-full h-20'>
